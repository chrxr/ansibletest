...
{% if env == "dev" %}
ZK_HOST="{{ hostvars['zoo1-dev']['ansible_host'] }}/solr"
{% elif env == "qa" %}
ZK_HOST="{{ hostvars['zoo1-qa']['ansible_host'] }}/solr"
{% else %}
ZK_HOST="{{ hostvars['zoo1-prd']['ansible_host'] }}/solr"
{% endif %}
...
{% else %}
SOLR_HOST="{{ ansible_eth0.ipv4.address }}"
{% endif %}
